...
class RemoteWeatherLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let expectedResult =
            RemoteWeatherData(name: "Shuzenji", weather: [WeatherData(weatherID: 803, main: "Clouds", weatherDescription: "broken clouds")], main: TemperatureData(temp: 281.48, tempMin: 281.48, tempMax: 281.48), list: nil)
